...
from cor import START_LAT, START_LON, END_LAT, END_LON, NOISE_DB, START_SHIFT, HEIGHT_SHIFT
...
parser.add_argument('--model-resume', default='checkpoint/our_model.pth.tar', type=str,
                    metavar='PATH', help='path to latest checkpoint (default: none)')

parser.add_argument('--save_dir', default='test_our_model/', type=str,
...
def test_our_model(our_model, paths, labels, image_augment, args):
    ...
    :param our_model: our angle robustness model
    :param paths: big map paths
    :param labels: big map labels
    :param image_augment: image augment
    :param args:
    ...
    with torch.no_grad():
        for i in range(1, 250):
            ...
            if path == -1:
                ...
                if len(args.start_path) > args.len - 1:
